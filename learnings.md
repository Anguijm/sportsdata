...
- **INSIGHT**: "More data helps" beats "recency helps" for NBA team-quality. For an 82-game season, rolling-20 is ~1/4 of the season (plenty of signal) and season-to-date for a team at game 60 is 3x that (still noisy for a few early-season outliers but swamps rolling-20 on volume). Below ~game-30, season-aggregate and rolling-N are near-identical by construction. The recency signal would have to be strong to overcome that — and it isn't for NBA.
