...
- **COUNCIL**: Gate 1 WARN (avg 7.2/10) → CLEAR after fix-pack (staged selection + MLP architecture pin). Gate 2 WARN (avg 7.6/10) → CLEAR with council override (bias gate failure traced to σ miscalibration; ewma-h21 segment-stable in both runs). PR #54 open, SHA `0730d4a`.
